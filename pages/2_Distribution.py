...
st.markdown("""
    ...
    .stButton>button { border: 1px solid #00d4ff !important; background-color: #1a1c24 !important; color: #00d4ff !important; }
    </style>
...
# Filtering for Manufacturer/Commander
